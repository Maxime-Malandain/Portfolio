...
const data = [
  ...
  },
  {
    ...
    review:
      "En tant que Fonctionnaire de Police,j'ai eu l'opportunité de travaillé dans de nombreuses branche et de vivre de nombreuses expériences. De la Police secours vers du judiciare en passant par CRS, Mes fonctions m'ont dotés de compétences essentielles telles que la gestion du stress, la résolution de problèmes, la communication efficace et l'éthique professionnelle.",
  },
  {
    id: '3',
    avatar: AVTR3,
